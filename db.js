...
mysal.connect("mysql+srv://database:avengers987654@db4free.net/Banking?retryWrites=true&w=majority" || "mysql://localhost:3306/banking", { useUnifiedTopology: true, useNewUrlParser: true, useFindAndModify: false })
    .then(() => {
